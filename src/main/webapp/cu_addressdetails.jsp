        ...
        <div class="container" style="font-family: Arial, Helvetica, sans-serif;">
            ...
            <div class="row">
                ...
                <div class="col-md-8 block-right">
                    <p class="block-right__title">Cập nhật địa chỉ</p>
                    <form action="cus_upadddetail" method="POST" class="row">
                        <div class="col-md-5">
                            <div class="common mb-2">
                                <p class="common__title">Họ tên</p>
                                <input type="text" class="form-control common__content" 
                                       name="name" value="${address.addRecName}"
                            ...
                            <div class="common mb-2">
                                ...
                                <input type="text" class="form-control common__content" 
                                       name="phone" value="${address.addRecPhone}"
                        ...
                        <div class="col-md-7">
                            ...
                            <!--                        <select class="form-select-sm common__content" id="city" 
                                                            name ="city" aria-label=".form-select-sm">
                                                        <option value="" selected class="">Chọn tỉnh thành</option>
                                                    </select>-->
                            <input type="text" name = "city" class="form-control-sm common__content" 
                                   value="${city}" placeholder="Nhập tên tỉnh/thành phố" required/>
                            <p class="error mb-2">&nbsp;</p>

                            <p class="common__title">Quận huyện</p>
                            <!--                        <select class="form-select-sm common__content" id="district" 
                                                            name = "district" aria-label=".form-select-sm">
                                                        <option value="" selected>Chọn quận huyện</option>
                                                    </select>-->
                            <input type="text" name = "district" class="form-control-sm common__content" 
                                   value="${district}" placeholder="Nhập tên quận/huyện" required/>
                            <p class="error mb-2">&nbsp;</p>

                            <p class="common__title">Phường xã</p>
                            <!--                        <select class="form-select-sm common__content" id="ward" aria-label=".form-select-sm">
                                                        <option value="" selected>Chọn phường xã</option>
                                                    </select>-->
                            <input type="text" name = "ward" class="form-control-sm common__content" 
                        ...
                        <button class="btn-save ml-3">Lưu thông tin</button>
                    </form>
