    ...
    <body style="font-family: Manrope">
        ...
        <div class="breadcrumb-option">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb__links" style="font-family: Manrope">
                            <a href="pub_home" style="font-family: Manrope"><i class="fa fa-home"></i> Trang chủ</a>
                            <a href="pub_viewpostlist">Bài viết</a>
                            <span>${requestScope.dNews.newsTitle}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container" style="margin: 30px 0;">
            <div class="row">
                <div class="col-md-12">
                    <!-- Table Product -->
                    <div class="ms-panel" style="font-family: Manrope">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="m-0 bold" style="font-size: 12px">${acc_dao.getAccByEmpId(cus_dao.getById(dNews.emId).cusId).accName}</p>
                            <p class="m-0 font-italic" style="font-size: 10px"><i class="fa-regular fa-calendar" style="color: #666666;"></i> ${requestScope.dNews.newsCreatedDate}</p>
                        </div>
                        <p class="line"></p>
                        <div class="ms-panel-header mb-3 mt-4" style="text-align: center; ">
                            <h6 style="font-family: Manrope; font-size: 30px; font-weight: bolder;
                                color: #bd0000; max-width: 70%; margin: auto; line-height: 1.5">${requestScope.dNews.newsTitle}</h6>
                        </div>
