                    ...
                    <form action="com_upprofile" method="post">
                        <div class="common mb-3">
                            ...
                            <input type="text" class="form-control common__content" 
                                   name = "name" value="${account.accName}" />
                            <p class="error">${errorName}</p> 
                        </div>

                        <div class="common mb-3">
                            <p class="common__title">Email</p>
                            <input type="text" disabled class="form-control common__content"
                        ...
                        <div class="common mb-3">
                            ...
                            <input type="text" class="form-control common__content" 
                                   name = "phone" value="${account.accPhone}" />
                            <p class="error">${errPhone}</p> 
                        </div>

                        <div class="common mb-3">
                            <p class="common__title">Ngày tháng năm sinh</p>
                            <input type="date" class="form-control common__content" 
                                   name = "dob" value="${account.accDoB}" />
