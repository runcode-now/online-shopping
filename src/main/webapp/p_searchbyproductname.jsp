...
<html>
    <head>
        ...
        <meta content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5, user-scalable=1"
              name="viewport" />
        <title>Những sản phẩm liên quan</title>
            ...
            <div class="row">
                <div class="col-lg-3 filter--all">
                    <div class="filter mx-5">
                        ...
                        <div class="filter--category my-3">
                            <p>Giá sản phẩm</p>
                            <form id="dosearch" action="pub_filterpriceandsizeproduct" method="get">
                                <div>
                                    <div>
                ...
                <div class="col-lg-9">
                    <div class="row mx-3">
                        ...
                        <!--Paging begin-->
                        <c:choose>
                            <c:when test="${checkPrice eq null}" >
                                <form id="submitPage" action="pub_searchproductbyproductname" method="post">
                            ...
                            <c:otherwise>
                                <form id="submitPage" action="pub_filterpriceandsizeproduct" method="get">
                                    <div class="col-lg-12 my-4">
                                        <nav aria-label="">
                                            <ul class="pagination pagination-sm">
                                                <c:forEach begin="1" end="${endPage}" var="i">
                                                    <li class="page-item ${tag == i?"active":""}" aria-current="page" >
                                                        ...
                                                        <a href="javascript:void(0)" class="page-link" onclick="submitPage(${i})">${i}</a>
                                                    </li>
                                                </c:forEach>
                                            </ul>
                                        </nav>                              
